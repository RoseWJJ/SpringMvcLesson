...
<link rel="${pageContext.request.contextPath}/detail/stylesheet" type="text/css" href="style/css/index_1.css" />
...
<div id="MainArea">
    <table class="MainArea_Content"  cellspacing="0" cellpadding="0">
		...
		<!--显示数据列表 -->
        <tbody id="TableData">
		<c:forEach var="temp" items="${requestScope.list.data}">
			<tr class="TableDetail1">
				...
				<td>
					<a href="${pageContext.request.contextPath}/detail/updateFood.jsp?foodId=${pageScope.temp.foodid}&foodName=${pageScope.temp.foodname}&price=${pageScope.temp.price}&path=${pageScope.temp.imgpath}"  class="FunctionButton">更新</a>				
					<a href="${pageContext.request.contextPath}/delete/${pageScope.temp.foodid}" class="FunctionButton">删除</a>				
				</td>
			</tr>	
        </c:forEach>
		...
		<%-- 分页代码 --%>
			...
			<a href="${pageContext.request.contextPath}/showFood?curPage=${requestScope.list.previesPage}">上页 </a>
			...
			<a href="${pageContext.request.contextPath}/showFood?curPage=${requestScope.list.nextPage}">下页 </a>
			<a href="${pageContext.request.contextPath}/showFood?curPage=${requestScope.list.totalPage}">尾页</a>
