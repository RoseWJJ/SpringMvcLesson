...
<html>
	<head>
		...
		<script type="text/javascript" src="style/js/page_common.js">
</script>
			...
			<form action="${pageContext.request.contextPath}/addFood" method="post" enctype="multipart/form-data">
				...
				<div class="ItemBlock_Title">
					<img width="4" height="7" border="0"
						src="style/images/item_point.gif">
					菜品信息&nbsp;
				</div>
						...
						<div class="ItemBlock2">
							<table cellpadding="0" cellspacing="0" class="mainForm">
								<tr>
									...
									<td>
										<input type="text" name="foodname" class="InputStyle"  />
								...
								<tr>
									...
									<td>
										<input type="text" name="price" class="InputStyle" />
									</td>
								</tr>
								<tr>
									<td width="80px">
