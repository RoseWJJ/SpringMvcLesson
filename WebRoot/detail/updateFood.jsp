            ...
            <div class="ItemBlock">
				<div class="ItemBlock2">
					<table cellpadding="0" cellspacing="0" class="mainForm">
						<tr>
							<td width="80px">菜名</td>
							<td><input type="text" name="foodName" class="InputStyle" value="${param.foodName}"/>
						...
						<tr>
							...
							<td>
									...
									src="${pageContext.request.contextPath}/myImage/${param.path}">
									<!--  <input type="text" name="imagePath" value="${param.IMAGEPATH}"/>-->
